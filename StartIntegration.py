...
ImportEmailAttachment.Integration(url_onevizion=url_onevizion, login_onevizion=login_onevizion, pass_onevizion=pass_onevizion, import_name=import_name, login_mail=login_mail, pass_mail=pass_mail, subject_mail=subject_mail)
